...
> **v1** — GUI 内嵌 AI 助理模块将在后续版本加入，当前 AI 能力通过 MCP 协议由外部工具（如 Claude Code）调用。
...
将所有 SSH 操作暴露为 AI 工具，让 Claude Code 等支持 MCP 协议的 AI 助手直接管理你的远程服务器：
...
详细安装和使用说明请参阅 [QUICK_START_CN.md](./QUICK_START_CN.md)。
